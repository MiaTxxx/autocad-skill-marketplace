...
中性示例（25×25、R5 圆角、对边距 12 六边形）在本机 CAD 里**实测回读**的值：

| 对象 | 回读值 |
|---|---|
| 25×25、R5 圆角、闭合轮廓 | `Length=91.4159`、`Area=603.5398`、`Closed=True` |
| 对边距 12 的正六边形 | `Length=41.5692`、`Area=124.7077` |
| 解析校验（独立算路） | 矩形圆角轮廓 `2(w−2r)+2(h−2r)+2πr` 代入 = `91.4159`；面积 `w·h−(4−π)r²` = `603.5398`；六边形 `6·(af/√3)` = `41.5692`、`(√3/2)·af²` = `124.7077` |
